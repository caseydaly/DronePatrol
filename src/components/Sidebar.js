...
class Sidebar extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div style={{ position: "fixed", width: "33%", height: "86%", backgroundColor: "white", marginLeft: "2%", marginTop: "2%", paddingRight: "1.65%", paddingLeft: "1.65%", paddingTop: "1.65%", borderRadius: 25, overflowY: "auto", cursor: 'default'}}>
